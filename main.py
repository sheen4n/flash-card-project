...
window = Tk()
window.title("Flashy")
window.config(background=BACKGROUND_COLOR, width=800,
              height=700, pady=50, padx=50)
...
wrong_button = Button(image=wrong_button_img, highlightthickness=0,
                      highlightbackground=BACKGROUND_COLOR, fg="black", command=next_card)
wrong_button.grid(row=1, column=0)

right_button_img = PhotoImage(file="./images/right.png")
right_button = Button(image=right_button_img, highlightthickness=0,
                      highlightbackground=BACKGROUND_COLOR, fg="black", command=is_known)
